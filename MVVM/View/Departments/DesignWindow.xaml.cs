...
namespace File_Manager
{
    ...
    public partial class DesignWindow : Window
    {
        ...
        public DesignWindow(int departmentId, int userId, string firstName, string lastName)
        {
        ...
        private async Task LoadDepartmentFiles()
        {
            try
            {
                var designFiles = await _context.DepartmentFiles
                ...
                FilesListView.ItemsSource = designFiles;
            }
            catch (Exception ex)
            {
